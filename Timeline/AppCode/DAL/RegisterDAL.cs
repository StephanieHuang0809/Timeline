...
namespace Timeline.AppCode.DAL
{
    ...
    public class RegisterDAL
    {
        ...
        public void updateProfile(int id, string firstName, string lastName, string gender, DateTime birthday, string email, string occupation)
        {
            ...
            try
            {
                ...
                param[5] = new SqlParameter("occupation", SqlDbType.VarChar, 50);
                ...
                param[5].Value = (object)occupation ?? DBNull.Value;
